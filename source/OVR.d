...
int OVR_LITTLE_ENDIAN() @property {
  auto ret = ovr_im.OVR_LITTLE_ENDIAN_get();
  return ret;
}

int OVR_BIG_ENDIAN() @property {
  auto ret = ovr_im.OVR_BIG_ENDIAN_get();
  return ret;
}

int OVR_BYTE_ORDER() @property {
  auto ret = ovr_im.OVR_BYTE_ORDER_get();
  return ret;
}

string OVR_BUILD_STRING() @property {
  string ret = std.conv.to!string(ovr_im.OVR_BUILD_STRING_get());
  return ret;
}

SWIGTYPE_p_unsigned_char UpperBitTable() @property {
  void* cPtr = ovr_im.UpperBitTable_get();
  SWIGTYPE_p_unsigned_char ret = (cPtr is null) ? null : new SWIGTYPE_p_unsigned_char(cPtr, false);
  return ret;
}

SWIGTYPE_p_unsigned_char LowerBitTable() @property {
  void* cPtr = ovr_im.LowerBitTable_get();
  SWIGTYPE_p_unsigned_char ret = (cPtr is null) ? null : new SWIGTYPE_p_unsigned_char(cPtr, false);
  return ret;
}

ubyte UpperBit(size_t val) {
  auto ret = ovr_im.UpperBit(val);
  return ret;
}

ubyte LowerBit(size_t val) {
  auto ret = ovr_im.LowerBit(val);
  return ret;
}
...
class MemUtil {
  ...
  public static void* swigGetCPtr(MemUtil obj) {
  ...
  public void dispose() {
    synchronized(this) {
      if (swigCPtr !is null) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          ovr_im.delete_MemUtil(cast(void*)swigCPtr);
        }
        swigCPtr = null;
      }
    }
  ...
  public static int Cmp(void* p1, void* p2, size_t byteCount) {
    auto ret = ovr_im.MemUtil_Cmp(cast(void*)p1, cast(void*)p2, byteCount);
    return ret;
  }

  public static int Cmp16(void* p1, void* p2, size_t int16Count) {
    auto ret = ovr_im.MemUtil_Cmp16(cast(void*)p1, cast(void*)p2, int16Count);
    return ret;
  }

  public static int Cmp32(void* p1, void* p2, size_t int32Count) {
    auto ret = ovr_im.MemUtil_Cmp32(cast(void*)p1, cast(void*)p2, int32Count);
    return ret;
  }

  public static int Cmp64(void* p1, void* p2, size_t int64Count) {
    auto ret = ovr_im.MemUtil_Cmp64(cast(void*)p1, cast(void*)p2, int64Count);
    return ret;
  }

  public this() {
    this(ovr_im.new_MemUtil(), true);
  }
}

void SwapOrder(void* pv, int size) {
  ovr_im.SwapOrder__SWIG_0(cast(void*)pv, size);
}

ubyte SwapOrder(ubyte v) {
  auto ret = ovr_im.SwapOrder__SWIG_1(v);
  return ret;
}

char SwapOrder(char v) {
  auto ret = ovr_im.SwapOrder__SWIG_2(v);
  return ret;
}

ushort SwapOrder(ushort v) {
  auto ret = ovr_im.SwapOrder__SWIG_3(v);
  return ret;
}

short SwapOrder(short v) {
  auto ret = ovr_im.SwapOrder__SWIG_4(v);
  return ret;
}

core.stdc.config.c_ulong SwapOrder(core.stdc.config.c_ulong v) {
  auto ret = ovr_im.SwapOrder__SWIG_5(v);
  return ret;
}

core.stdc.config.c_long SwapOrder(core.stdc.config.c_long p) {
  auto ret = ovr_im.SwapOrder__SWIG_6(p);
  return ret;
}

SWIGTYPE_p_unsigned___int64 SwapOrder(SWIGTYPE_p_unsigned___int64 v) {
  SWIGTYPE_p_unsigned___int64 ret = new SWIGTYPE_p_unsigned___int64(ovr_im.SwapOrder__SWIG_7(SWIGTYPE_p_unsigned___int64.swigGetCPtr(v)), true);
  if (ovr_im.SwigPendingException.isPending) throw ovr_im.SwigPendingException.retrieve();
  return ret;
}

SWIGTYPE_p___int64 SwapOrder(SWIGTYPE_p___int64 v) {
  SWIGTYPE_p___int64 ret = new SWIGTYPE_p___int64(ovr_im.SwapOrder__SWIG_8(SWIGTYPE_p___int64.swigGetCPtr(v)), true);
  if (ovr_im.SwigPendingException.isPending) throw ovr_im.SwigPendingException.retrieve();
  return ret;
}

float SwapOrder(float p) {
  auto ret = ovr_im.SwapOrder__SWIG_9(p);
  return ret;
}

double SwapOrder(double p) {
  auto ret = ovr_im.SwapOrder__SWIG_10(p);
  return ret;
}

ubyte LEToSystem(ubyte v) {
  auto ret = ovr_im.LEToSystem__SWIG_0(v);
  return ret;
}

char LEToSystem(char v) {
  auto ret = ovr_im.LEToSystem__SWIG_1(v);
  return ret;
}

ushort LEToSystem(ushort v) {
  auto ret = ovr_im.LEToSystem__SWIG_2(v);
  return ret;
}

short LEToSystem(short v) {
  auto ret = ovr_im.LEToSystem__SWIG_3(v);
  return ret;
}

core.stdc.config.c_ulong LEToSystem(core.stdc.config.c_ulong v) {
  auto ret = ovr_im.LEToSystem__SWIG_4(v);
  return ret;
}

core.stdc.config.c_long LEToSystem(core.stdc.config.c_long v) {
  auto ret = ovr_im.LEToSystem__SWIG_5(v);
  return ret;
}

SWIGTYPE_p_unsigned___int64 LEToSystem(SWIGTYPE_p_unsigned___int64 v) {
  SWIGTYPE_p_unsigned___int64 ret = new SWIGTYPE_p_unsigned___int64(ovr_im.LEToSystem__SWIG_6(SWIGTYPE_p_unsigned___int64.swigGetCPtr(v)), true);
  if (ovr_im.SwigPendingException.isPending) throw ovr_im.SwigPendingException.retrieve();
  return ret;
}

SWIGTYPE_p___int64 LEToSystem(SWIGTYPE_p___int64 v) {
  SWIGTYPE_p___int64 ret = new SWIGTYPE_p___int64(ovr_im.LEToSystem__SWIG_7(SWIGTYPE_p___int64.swigGetCPtr(v)), true);
  if (ovr_im.SwigPendingException.isPending) throw ovr_im.SwigPendingException.retrieve();
  return ret;
}

float LEToSystem(float v) {
  auto ret = ovr_im.LEToSystem__SWIG_8(v);
  return ret;
}

double LEToSystem(double v) {
  auto ret = ovr_im.LEToSystem__SWIG_9(v);
  return ret;
}

ubyte BEToSystem(ubyte v) {
  auto ret = ovr_im.BEToSystem__SWIG_0(v);
  return ret;
}

char BEToSystem(char v) {
  auto ret = ovr_im.BEToSystem__SWIG_1(v);
  return ret;
}

ushort BEToSystem(ushort v) {
  auto ret = ovr_im.BEToSystem__SWIG_2(v);
  return ret;
}

short BEToSystem(short v) {
  auto ret = ovr_im.BEToSystem__SWIG_3(v);
  return ret;
}

core.stdc.config.c_ulong BEToSystem(core.stdc.config.c_ulong v) {
  auto ret = ovr_im.BEToSystem__SWIG_4(v);
  return ret;
}

core.stdc.config.c_long BEToSystem(core.stdc.config.c_long v) {
  auto ret = ovr_im.BEToSystem__SWIG_5(v);
  return ret;
}

SWIGTYPE_p_unsigned___int64 BEToSystem(SWIGTYPE_p_unsigned___int64 v) {
  SWIGTYPE_p_unsigned___int64 ret = new SWIGTYPE_p_unsigned___int64(ovr_im.BEToSystem__SWIG_6(SWIGTYPE_p_unsigned___int64.swigGetCPtr(v)), true);
  if (ovr_im.SwigPendingException.isPending) throw ovr_im.SwigPendingException.retrieve();
  return ret;
}

SWIGTYPE_p___int64 BEToSystem(SWIGTYPE_p___int64 v) {
  SWIGTYPE_p___int64 ret = new SWIGTYPE_p___int64(ovr_im.BEToSystem__SWIG_7(SWIGTYPE_p___int64.swigGetCPtr(v)), true);
  if (ovr_im.SwigPendingException.isPending) throw ovr_im.SwigPendingException.retrieve();
  return ret;
}

float BEToSystem(float v) {
  auto ret = ovr_im.BEToSystem__SWIG_8(v);
  return ret;
}

double BEToSystem(double v) {
  auto ret = ovr_im.BEToSystem__SWIG_9(v);
  return ret;
}

ubyte SystemToLE(ubyte v) {
  auto ret = ovr_im.SystemToLE__SWIG_0(v);
  return ret;
}

char SystemToLE(char v) {
  auto ret = ovr_im.SystemToLE__SWIG_1(v);
  return ret;
}

ushort SystemToLE(ushort v) {
  auto ret = ovr_im.SystemToLE__SWIG_2(v);
  return ret;
}

short SystemToLE(short v) {
  auto ret = ovr_im.SystemToLE__SWIG_3(v);
  return ret;
}

core.stdc.config.c_ulong SystemToLE(core.stdc.config.c_ulong v) {
  auto ret = ovr_im.SystemToLE__SWIG_4(v);
  return ret;
}

core.stdc.config.c_long SystemToLE(core.stdc.config.c_long v) {
  auto ret = ovr_im.SystemToLE__SWIG_5(v);
  return ret;
}

SWIGTYPE_p_unsigned___int64 SystemToLE(SWIGTYPE_p_unsigned___int64 v) {
  SWIGTYPE_p_unsigned___int64 ret = new SWIGTYPE_p_unsigned___int64(ovr_im.SystemToLE__SWIG_6(SWIGTYPE_p_unsigned___int64.swigGetCPtr(v)), true);
  if (ovr_im.SwigPendingException.isPending) throw ovr_im.SwigPendingException.retrieve();
  return ret;
}

SWIGTYPE_p___int64 SystemToLE(SWIGTYPE_p___int64 v) {
  SWIGTYPE_p___int64 ret = new SWIGTYPE_p___int64(ovr_im.SystemToLE__SWIG_7(SWIGTYPE_p___int64.swigGetCPtr(v)), true);
  if (ovr_im.SwigPendingException.isPending) throw ovr_im.SwigPendingException.retrieve();
  return ret;
}

float SystemToLE(float v) {
  auto ret = ovr_im.SystemToLE__SWIG_8(v);
  return ret;
}

double SystemToLE(double v) {
  auto ret = ovr_im.SystemToLE__SWIG_9(v);
  return ret;
}

ubyte SystemToBE(ubyte v) {
  auto ret = ovr_im.SystemToBE__SWIG_0(v);
  return ret;
}

char SystemToBE(char v) {
  auto ret = ovr_im.SystemToBE__SWIG_1(v);
  return ret;
}

ushort SystemToBE(ushort v) {
  auto ret = ovr_im.SystemToBE__SWIG_2(v);
  return ret;
}

short SystemToBE(short v) {
  auto ret = ovr_im.SystemToBE__SWIG_3(v);
  return ret;
}

core.stdc.config.c_ulong SystemToBE(core.stdc.config.c_ulong v) {
  auto ret = ovr_im.SystemToBE__SWIG_4(v);
  return ret;
}

core.stdc.config.c_long SystemToBE(core.stdc.config.c_long v) {
  auto ret = ovr_im.SystemToBE__SWIG_5(v);
  return ret;
}

SWIGTYPE_p_unsigned___int64 SystemToBE(SWIGTYPE_p_unsigned___int64 v) {
  SWIGTYPE_p_unsigned___int64 ret = new SWIGTYPE_p_unsigned___int64(ovr_im.SystemToBE__SWIG_6(SWIGTYPE_p_unsigned___int64.swigGetCPtr(v)), true);
  if (ovr_im.SwigPendingException.isPending) throw ovr_im.SwigPendingException.retrieve();
  return ret;
}

SWIGTYPE_p___int64 SystemToBE(SWIGTYPE_p___int64 v) {
  SWIGTYPE_p___int64 ret = new SWIGTYPE_p___int64(ovr_im.SystemToBE__SWIG_7(SWIGTYPE_p___int64.swigGetCPtr(v)), true);
  if (ovr_im.SwigPendingException.isPending) throw ovr_im.SwigPendingException.retrieve();
  return ret;
}

float SystemToBE(float v) {
  auto ret = ovr_im.SystemToBE__SWIG_8(v);
  return ret;
}

double SystemToBE(double v) {
  auto ret = ovr_im.SystemToBE__SWIG_9(v);
  return ret;
}

SWIGTYPE_p_ptrdiff_t GetLength(string putf8str, SWIGTYPE_p_ptrdiff_t length) {
  SWIGTYPE_p_ptrdiff_t ret = new SWIGTYPE_p_ptrdiff_t(ovr_im.GetLength__SWIG_0((putf8str ? std.string.toStringz(putf8str) : null), SWIGTYPE_p_ptrdiff_t.swigGetCPtr(length)), true);
  if (ovr_im.SwigPendingException.isPending) throw ovr_im.SwigPendingException.retrieve();
  return ret;
}

SWIGTYPE_p_ptrdiff_t GetLength(string putf8str) {
  SWIGTYPE_p_ptrdiff_t ret = new SWIGTYPE_p_ptrdiff_t(ovr_im.GetLength__SWIG_1((putf8str ? std.string.toStringz(putf8str) : null)), true);
  return ret;
}

core.stdc.config.c_ulong GetCharAt(SWIGTYPE_p_ptrdiff_t index, string putf8str, SWIGTYPE_p_ptrdiff_t length) {
  auto ret = ovr_im.GetCharAt__SWIG_0(SWIGTYPE_p_ptrdiff_t.swigGetCPtr(index), (putf8str ? std.string.toStringz(putf8str) : null), SWIGTYPE_p_ptrdiff_t.swigGetCPtr(length));
  if (ovr_im.SwigPendingException.isPending) throw ovr_im.SwigPendingException.retrieve();
  return ret;
}

core.stdc.config.c_ulong GetCharAt(SWIGTYPE_p_ptrdiff_t index, string putf8str) {
  auto ret = ovr_im.GetCharAt__SWIG_1(SWIGTYPE_p_ptrdiff_t.swigGetCPtr(index), (putf8str ? std.string.toStringz(putf8str) : null));
  if (ovr_im.SwigPendingException.isPending) throw ovr_im.SwigPendingException.retrieve();
  return ret;
}

SWIGTYPE_p_ptrdiff_t GetByteIndex(SWIGTYPE_p_ptrdiff_t index, string putf8str, SWIGTYPE_p_ptrdiff_t length) {
  SWIGTYPE_p_ptrdiff_t ret = new SWIGTYPE_p_ptrdiff_t(ovr_im.GetByteIndex__SWIG_0(SWIGTYPE_p_ptrdiff_t.swigGetCPtr(index), (putf8str ? std.string.toStringz(putf8str) : null), SWIGTYPE_p_ptrdiff_t.swigGetCPtr(length)), true);
  if (ovr_im.SwigPendingException.isPending) throw ovr_im.SwigPendingException.retrieve();
  return ret;
}

SWIGTYPE_p_ptrdiff_t GetByteIndex(SWIGTYPE_p_ptrdiff_t index, string putf8str) {
  SWIGTYPE_p_ptrdiff_t ret = new SWIGTYPE_p_ptrdiff_t(ovr_im.GetByteIndex__SWIG_1(SWIGTYPE_p_ptrdiff_t.swigGetCPtr(index), (putf8str ? std.string.toStringz(putf8str) : null)), true);
  if (ovr_im.SwigPendingException.isPending) throw ovr_im.SwigPendingException.retrieve();
  return ret;
}

SWIGTYPE_p_ptrdiff_t GetEncodeStringSize(SWIGTYPE_p_wchar_t pchar, SWIGTYPE_p_ptrdiff_t length) {
  SWIGTYPE_p_ptrdiff_t ret = new SWIGTYPE_p_ptrdiff_t(ovr_im.GetEncodeStringSize__SWIG_0(SWIGTYPE_p_wchar_t.swigGetCPtr(pchar), SWIGTYPE_p_ptrdiff_t.swigGetCPtr(length)), true);
  if (ovr_im.SwigPendingException.isPending) throw ovr_im.SwigPendingException.retrieve();
  return ret;
}

SWIGTYPE_p_ptrdiff_t GetEncodeStringSize(SWIGTYPE_p_wchar_t pchar) {
  SWIGTYPE_p_ptrdiff_t ret = new SWIGTYPE_p_ptrdiff_t(ovr_im.GetEncodeStringSize__SWIG_1(SWIGTYPE_p_wchar_t.swigGetCPtr(pchar)), true);
  return ret;
}

void EncodeString(string pbuff, SWIGTYPE_p_wchar_t pchar, SWIGTYPE_p_ptrdiff_t length) {
  ovr_im.EncodeString__SWIG_0((pbuff ? std.string.toStringz(pbuff) : null), SWIGTYPE_p_wchar_t.swigGetCPtr(pchar), SWIGTYPE_p_ptrdiff_t.swigGetCPtr(length));
  if (ovr_im.SwigPendingException.isPending) throw ovr_im.SwigPendingException.retrieve();
}

void EncodeString(string pbuff, SWIGTYPE_p_wchar_t pchar) {
  ovr_im.EncodeString__SWIG_1((pbuff ? std.string.toStringz(pbuff) : null), SWIGTYPE_p_wchar_t.swigGetCPtr(pchar));
}

size_t DecodeString(SWIGTYPE_p_wchar_t pbuff, string putf8str, SWIGTYPE_p_ptrdiff_t bytesLen) {
  auto ret = ovr_im.DecodeString__SWIG_0(SWIGTYPE_p_wchar_t.swigGetCPtr(pbuff), (putf8str ? std.string.toStringz(putf8str) : null), SWIGTYPE_p_ptrdiff_t.swigGetCPtr(bytesLen));
  if (ovr_im.SwigPendingException.isPending) throw ovr_im.SwigPendingException.retrieve();
  return ret;
}

size_t DecodeString(SWIGTYPE_p_wchar_t pbuff, string putf8str) {
  auto ret = ovr_im.DecodeString__SWIG_1(SWIGTYPE_p_wchar_t.swigGetCPtr(pbuff), (putf8str ? std.string.toStringz(putf8str) : null));
  return ret;
}

int GetEncodeCharSize(core.stdc.config.c_ulong ucsCharacter) {
  auto ret = ovr_im.GetEncodeCharSize(ucsCharacter);
  return ret;
}

void EncodeChar(string pbuffer, SWIGTYPE_p_ptrdiff_t poffset, core.stdc.config.c_ulong ucsCharacter) {
  ovr_im.EncodeChar((pbuffer ? std.string.toStringz(pbuffer) : null), SWIGTYPE_p_ptrdiff_t.swigGetCPtr(poffset), ucsCharacter);
}

core.stdc.config.c_ulong DecodeNextChar_Advance0(char** putf8Buffer) {
  auto ret = ovr_im.DecodeNextChar_Advance0(cast(void*)putf8Buffer);
  return ret;
}

core.stdc.config.c_ulong DecodeNextChar(char** putf8Buffer) {
  auto ret = ovr_im.DecodeNextChar(cast(void*)putf8Buffer);
  return ret;
}
...
class RefCountImplCore {
  ...
  public static void* swigGetCPtr(RefCountImplCore obj) {
    return (obj is null) ? null : obj.swigCPtr;
  }
  ...
  public void dispose() {
    synchronized(this) {
      if (swigCPtr !is null) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          ovr_im.delete_RefCountImplCore(cast(void*)swigCPtr);
        }
        swigCPtr = null;
      }
    }
  ...
  public this() {
    this(ovr_im.new_RefCountImplCore(), true);
  }

  public int GetRefCount() const {
    auto ret = ovr_im.RefCountImplCore_GetRefCount(cast(void*)swigCPtr);
    return ret;
  }

  public static void checkInvalidDelete(RefCountImplCore arg0) {
    ovr_im.RefCountImplCore_checkInvalidDelete(RefCountImplCore.swigGetCPtr(arg0));
  }
}
...
class RefCountNTSImplCore {
  ...
  public static void* swigGetCPtr(RefCountNTSImplCore obj) {
    return (obj is null) ? null : obj.swigCPtr;
  }
  ...
  public void dispose() {
    synchronized(this) {
      if (swigCPtr !is null) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          ovr_im.delete_RefCountNTSImplCore(cast(void*)swigCPtr);
        }
        swigCPtr = null;
      }
    }
  ...
  public this() {
    this(ovr_im.new_RefCountNTSImplCore(), true);
  }

  public int GetRefCount() const {
    auto ret = ovr_im.RefCountNTSImplCore_GetRefCount(cast(void*)swigCPtr);
    return ret;
  }

  public static void checkInvalidDelete(RefCountNTSImplCore arg0) {
    ovr_im.RefCountNTSImplCore_checkInvalidDelete(RefCountNTSImplCore.swigGetCPtr(arg0));
  }
}

class RefCountImpl : RefCountImplCore {
  private void* swigCPtr;

  public this(void* cObject, bool ownCObject) {
    super(ovr_im.RefCountImpl_Upcast(cObject), ownCObject);
    swigCPtr = cObject;
  }

  public static void* swigGetCPtr(RefCountImpl obj) {
    return (obj is null) ? null : obj.swigCPtr;
  }
  ...
  public override void dispose() {
    synchronized(this) {
      if (swigCPtr !is null) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          ovr_im.delete_RefCountImpl(cast(void*)swigCPtr);
        }
        swigCPtr = null;
        super.dispose();
      }
  ...
  public void AddRef() {
    ovr_im.RefCountImpl_AddRef(cast(void*)swigCPtr);
  }

  public void Release() {
    ovr_im.RefCountImpl_Release(cast(void*)swigCPtr);
  }

  public this() {
    this(ovr_im.new_RefCountImpl(), true);
  }
}

class RefCountVImpl : RefCountImplCore {
  private void* swigCPtr;

  public this(void* cObject, bool ownCObject) {
    super(ovr_im.RefCountVImpl_Upcast(cObject), ownCObject);
    swigCPtr = cObject;
  }

  public static void* swigGetCPtr(RefCountVImpl obj) {
    return (obj is null) ? null : obj.swigCPtr;
  }
  ...
  public override void dispose() {
    synchronized(this) {
      if (swigCPtr !is null) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          ovr_im.delete_RefCountVImpl(cast(void*)swigCPtr);
        }
        swigCPtr = null;
        super.dispose();
      }
  ...
  public void AddRef() {
    ovr_im.RefCountVImpl_AddRef(cast(void*)swigCPtr);
  }

  public void Release() {
    ovr_im.RefCountVImpl_Release(cast(void*)swigCPtr);
  }

  public this() {
    this(ovr_im.new_RefCountVImpl(), true);
  }
}

class RefCountNTSImpl : RefCountNTSImplCore {
  private void* swigCPtr;

  public this(void* cObject, bool ownCObject) {
    super(ovr_im.RefCountNTSImpl_Upcast(cObject), ownCObject);
    swigCPtr = cObject;
  }

  public static void* swigGetCPtr(RefCountNTSImpl obj) {
    return (obj is null) ? null : obj.swigCPtr;
  }
  ...
  public override void dispose() {
    synchronized(this) {
      if (swigCPtr !is null) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          ovr_im.delete_RefCountNTSImpl(cast(void*)swigCPtr);
        }
        swigCPtr = null;
        super.dispose();
      }
  ...
  public void AddRef() const {
    ovr_im.RefCountNTSImpl_AddRef(cast(void*)swigCPtr);
  }

  public void Release() const {
    ovr_im.RefCountNTSImpl_Release(cast(void*)swigCPtr);
  }

  public this() {
    this(ovr_im.new_RefCountNTSImpl(), true);
  }
}
...
void* ReturnArg0(void* p) {
  auto ret = cast(void*)ovr_im.ReturnArg0(cast(void*)p);
  return ret;
}

string OVR_itoa(int val, string dest, size_t destsize, int radix) {
  string ret = std.conv.to!string(ovr_im.OVR_itoa(val, (dest ? std.string.toStringz(dest) : null), destsize, radix));
  return ret;
}

size_t OVR_strlen(string str) {
  auto ret = ovr_im.OVR_strlen((str ? std.string.toStringz(str) : null));
  return ret;
}

string OVR_strcpy(string dest, size_t destsize, string src) {
  string ret = std.conv.to!string(ovr_im.OVR_strcpy((dest ? std.string.toStringz(dest) : null), destsize, (src ? std.string.toStringz(src) : null)));
  return ret;
}

string OVR_strncpy(string dest, size_t destsize, string src, size_t count) {
  string ret = std.conv.to!string(ovr_im.OVR_strncpy((dest ? std.string.toStringz(dest) : null), destsize, (src ? std.string.toStringz(src) : null), count));
  return ret;
}

string OVR_strcat(string dest, size_t destsize, string src) {
  string ret = std.conv.to!string(ovr_im.OVR_strcat((dest ? std.string.toStringz(dest) : null), destsize, (src ? std.string.toStringz(src) : null)));
  return ret;
}

int OVR_strcmp(string dest, string src) {
  auto ret = ovr_im.OVR_strcmp((dest ? std.string.toStringz(dest) : null), (src ? std.string.toStringz(src) : null));
  return ret;
}

string OVR_strchr(string str, char c) {
  string ret = std.conv.to!string(ovr_im.OVR_strchr__SWIG_0((str ? std.string.toStringz(str) : null), c));
  return ret;
}

string OVR_strrchr(string str, char c) {
  string ret = std.conv.to!string(ovr_im.OVR_strrchr__SWIG_0((str ? std.string.toStringz(str) : null), c));
  return ret;
}

ubyte* OVR_memrchr(ubyte* str, size_t size, ubyte c) {
  auto ret = cast(ubyte*)ovr_im.OVR_memrchr(cast(void*)str, size, c);
  return ret;
}

double OVR_strtod(string arg0, char** tailptr) {
  auto ret = ovr_im.OVR_strtod((arg0 ? std.string.toStringz(arg0) : null), cast(void*)tailptr);
  return ret;
}

core.stdc.config.c_long OVR_strtol(string arg0, char** tailptr, int radix) {
  auto ret = ovr_im.OVR_strtol((arg0 ? std.string.toStringz(arg0) : null), cast(void*)tailptr, radix);
  return ret;
}

core.stdc.config.c_ulong OVR_strtoul(string arg0, char** tailptr, int radix) {
  auto ret = ovr_im.OVR_strtoul((arg0 ? std.string.toStringz(arg0) : null), cast(void*)tailptr, radix);
  return ret;
}

int OVR_strncmp(string ws1, string ws2, size_t size) {
  auto ret = ovr_im.OVR_strncmp((ws1 ? std.string.toStringz(ws1) : null), (ws2 ? std.string.toStringz(ws2) : null), size);
  return ret;
}

SWIGTYPE_p_unsigned___int64 OVR_strtouq(string nptr, char** endptr, int base) {
  SWIGTYPE_p_unsigned___int64 ret = new SWIGTYPE_p_unsigned___int64(ovr_im.OVR_strtouq((nptr ? std.string.toStringz(nptr) : null), cast(void*)endptr, base), true);
  return ret;
}

SWIGTYPE_p___int64 OVR_strtoq(string nptr, char** endptr, int base) {
  SWIGTYPE_p___int64 ret = new SWIGTYPE_p___int64(ovr_im.OVR_strtoq((nptr ? std.string.toStringz(nptr) : null), cast(void*)endptr, base), true);
  return ret;
}

SWIGTYPE_p___int64 OVR_atoq(string arg0) {
  SWIGTYPE_p___int64 ret = new SWIGTYPE_p___int64(ovr_im.OVR_atoq((arg0 ? std.string.toStringz(arg0) : null)), true);
  return ret;
}

SWIGTYPE_p_unsigned___int64 OVR_atouq(string arg0) {
  SWIGTYPE_p_unsigned___int64 ret = new SWIGTYPE_p_unsigned___int64(ovr_im.OVR_atouq((arg0 ? std.string.toStringz(arg0) : null)), true);
  return ret;
}

int OVR_stricmp(string dest, string src) {
  auto ret = ovr_im.OVR_stricmp((dest ? std.string.toStringz(dest) : null), (src ? std.string.toStringz(src) : null));
  return ret;
}

int OVR_strnicmp(string dest, string src, size_t count) {
  auto ret = ovr_im.OVR_strnicmp((dest ? std.string.toStringz(dest) : null), (src ? std.string.toStringz(src) : null), count);
  return ret;
}

size_t OVR_sprintf(string dest, size_t destsize, string format) {
  auto ret = ovr_im.OVR_sprintf((dest ? std.string.toStringz(dest) : null), destsize, (format ? std.string.toStringz(format) : null));
  return ret;
}

size_t OVR_vsprintf(string dest, size_t destsize, string format, SWIGTYPE_p_va_list argList) {
  auto ret = ovr_im.OVR_vsprintf((dest ? std.string.toStringz(dest) : null), destsize, (format ? std.string.toStringz(format) : null), SWIGTYPE_p_va_list.swigGetCPtr(argList));
  if (ovr_im.SwigPendingException.isPending) throw ovr_im.SwigPendingException.retrieve();
  return ret;
}

size_t OVR_vscprintf(string format, SWIGTYPE_p_va_list argList) {
  auto ret = ovr_im.OVR_vscprintf((format ? std.string.toStringz(format) : null), SWIGTYPE_p_va_list.swigGetCPtr(argList));
  if (ovr_im.SwigPendingException.isPending) throw ovr_im.SwigPendingException.retrieve();
  return ret;
}

SWIGTYPE_p_wchar_t OVR_wcscpy(SWIGTYPE_p_wchar_t dest, size_t destsize, SWIGTYPE_p_wchar_t src) {
  void* cPtr = ovr_im.OVR_wcscpy(SWIGTYPE_p_wchar_t.swigGetCPtr(dest), destsize, SWIGTYPE_p_wchar_t.swigGetCPtr(src));
  SWIGTYPE_p_wchar_t ret = (cPtr is null) ? null : new SWIGTYPE_p_wchar_t(cPtr, false);
  return ret;
}

SWIGTYPE_p_wchar_t OVR_wcsncpy(SWIGTYPE_p_wchar_t dest, size_t destsize, SWIGTYPE_p_wchar_t src, size_t count) {
  void* cPtr = ovr_im.OVR_wcsncpy(SWIGTYPE_p_wchar_t.swigGetCPtr(dest), destsize, SWIGTYPE_p_wchar_t.swigGetCPtr(src), count);
  SWIGTYPE_p_wchar_t ret = (cPtr is null) ? null : new SWIGTYPE_p_wchar_t(cPtr, false);
  return ret;
}

SWIGTYPE_p_wchar_t OVR_wcscat(SWIGTYPE_p_wchar_t dest, size_t destsize, SWIGTYPE_p_wchar_t src) {
  void* cPtr = ovr_im.OVR_wcscat(SWIGTYPE_p_wchar_t.swigGetCPtr(dest), destsize, SWIGTYPE_p_wchar_t.swigGetCPtr(src));
  SWIGTYPE_p_wchar_t ret = (cPtr is null) ? null : new SWIGTYPE_p_wchar_t(cPtr, false);
  return ret;
}

size_t OVR_wcslen(SWIGTYPE_p_wchar_t str) {
  auto ret = ovr_im.OVR_wcslen(SWIGTYPE_p_wchar_t.swigGetCPtr(str));
  return ret;
}

int OVR_wcscmp(SWIGTYPE_p_wchar_t a, SWIGTYPE_p_wchar_t b) {
  auto ret = ovr_im.OVR_wcscmp(SWIGTYPE_p_wchar_t.swigGetCPtr(a), SWIGTYPE_p_wchar_t.swigGetCPtr(b));
  return ret;
}

int OVR_wcsicmp(SWIGTYPE_p_wchar_t a, SWIGTYPE_p_wchar_t b) {
  auto ret = ovr_im.OVR_wcsicmp(SWIGTYPE_p_wchar_t.swigGetCPtr(a), SWIGTYPE_p_wchar_t.swigGetCPtr(b));
  return ret;
}

int OVR_wcsicoll(SWIGTYPE_p_wchar_t a, SWIGTYPE_p_wchar_t b) {
  auto ret = ovr_im.OVR_wcsicoll(SWIGTYPE_p_wchar_t.swigGetCPtr(a), SWIGTYPE_p_wchar_t.swigGetCPtr(b));
  return ret;
}

int OVR_wcscoll(SWIGTYPE_p_wchar_t a, SWIGTYPE_p_wchar_t b) {
  auto ret = ovr_im.OVR_wcscoll(SWIGTYPE_p_wchar_t.swigGetCPtr(a), SWIGTYPE_p_wchar_t.swigGetCPtr(b));
  return ret;
}

int UnicodeCharIs(ushort* table, SWIGTYPE_p_wchar_t charCode) {
  auto ret = ovr_im.UnicodeCharIs(cast(void*)table, SWIGTYPE_p_wchar_t.swigGetCPtr(charCode));
  if (ovr_im.SwigPendingException.isPending) throw ovr_im.SwigPendingException.retrieve();
  return ret;
}

SWIGTYPE_p_unsigned_short UnicodeAlnumBits() @property {
  void* cPtr = ovr_im.UnicodeAlnumBits_get();
  SWIGTYPE_p_unsigned_short ret = (cPtr is null) ? null : new SWIGTYPE_p_unsigned_short(cPtr, false);
  return ret;
}

SWIGTYPE_p_unsigned_short UnicodeAlphaBits() @property {
  void* cPtr = ovr_im.UnicodeAlphaBits_get();
  SWIGTYPE_p_unsigned_short ret = (cPtr is null) ? null : new SWIGTYPE_p_unsigned_short(cPtr, false);
  return ret;
}

SWIGTYPE_p_unsigned_short UnicodeDigitBits() @property {
  void* cPtr = ovr_im.UnicodeDigitBits_get();
  SWIGTYPE_p_unsigned_short ret = (cPtr is null) ? null : new SWIGTYPE_p_unsigned_short(cPtr, false);
  return ret;
}

SWIGTYPE_p_unsigned_short UnicodeSpaceBits() @property {
  void* cPtr = ovr_im.UnicodeSpaceBits_get();
  SWIGTYPE_p_unsigned_short ret = (cPtr is null) ? null : new SWIGTYPE_p_unsigned_short(cPtr, false);
  return ret;
}

SWIGTYPE_p_unsigned_short UnicodeXDigitBits() @property {
  void* cPtr = ovr_im.UnicodeXDigitBits_get();
  SWIGTYPE_p_unsigned_short ret = (cPtr is null) ? null : new SWIGTYPE_p_unsigned_short(cPtr, false);
  return ret;
}

int OVR_iswalnum(SWIGTYPE_p_wchar_t charCode) {
  auto ret = ovr_im.OVR_iswalnum(SWIGTYPE_p_wchar_t.swigGetCPtr(charCode));
  if (ovr_im.SwigPendingException.isPending) throw ovr_im.SwigPendingException.retrieve();
  return ret;
}

int OVR_iswalpha(SWIGTYPE_p_wchar_t charCode) {
  auto ret = ovr_im.OVR_iswalpha(SWIGTYPE_p_wchar_t.swigGetCPtr(charCode));
  if (ovr_im.SwigPendingException.isPending) throw ovr_im.SwigPendingException.retrieve();
  return ret;
}

int OVR_iswdigit(SWIGTYPE_p_wchar_t charCode) {
  auto ret = ovr_im.OVR_iswdigit(SWIGTYPE_p_wchar_t.swigGetCPtr(charCode));
  if (ovr_im.SwigPendingException.isPending) throw ovr_im.SwigPendingException.retrieve();
  return ret;
}

int OVR_iswspace(SWIGTYPE_p_wchar_t charCode) {
  auto ret = ovr_im.OVR_iswspace(SWIGTYPE_p_wchar_t.swigGetCPtr(charCode));
  if (ovr_im.SwigPendingException.isPending) throw ovr_im.SwigPendingException.retrieve();
  return ret;
}

int OVR_iswxdigit(SWIGTYPE_p_wchar_t charCode) {
  auto ret = ovr_im.OVR_iswxdigit(SWIGTYPE_p_wchar_t.swigGetCPtr(charCode));
  if (ovr_im.SwigPendingException.isPending) throw ovr_im.SwigPendingException.retrieve();
  return ret;
}

int OVR_towupper(SWIGTYPE_p_wchar_t charCode) {
  auto ret = ovr_im.OVR_towupper(SWIGTYPE_p_wchar_t.swigGetCPtr(charCode));
  if (ovr_im.SwigPendingException.isPending) throw ovr_im.SwigPendingException.retrieve();
  return ret;
}

int OVR_towlower(SWIGTYPE_p_wchar_t charCode) {
  auto ret = ovr_im.OVR_towlower(SWIGTYPE_p_wchar_t.swigGetCPtr(charCode));
  if (ovr_im.SwigPendingException.isPending) throw ovr_im.SwigPendingException.retrieve();
  return ret;
}

int OVR_tolower(int c) {
  auto ret = ovr_im.OVR_tolower(c);
  return ret;
}

int OVR_toupper(int c) {
  auto ret = ovr_im.OVR_toupper(c);
  return ret;
}

double OVR_wcstod(SWIGTYPE_p_wchar_t arg0, SWIGTYPE_p_p_wchar_t tailptr) {
  auto ret = ovr_im.OVR_wcstod(SWIGTYPE_p_wchar_t.swigGetCPtr(arg0), SWIGTYPE_p_p_wchar_t.swigGetCPtr(tailptr));
  return ret;
}

core.stdc.config.c_long OVR_wcstol(SWIGTYPE_p_wchar_t arg0, SWIGTYPE_p_p_wchar_t tailptr, int radix) {
  auto ret = ovr_im.OVR_wcstol(SWIGTYPE_p_wchar_t.swigGetCPtr(arg0), SWIGTYPE_p_p_wchar_t.swigGetCPtr(tailptr), radix);
  return ret;
}
...
class SWIGTYPE_p_p_wchar_t {
  ...
  public static void* swigGetCPtr(SWIGTYPE_p_p_wchar_t obj) {
    return (obj is null) ? null : obj.swigCPtr;
  }
...
class SWIGTYPE_p___int64 {
  ...
  public static void* swigGetCPtr(SWIGTYPE_p___int64 obj) {
    return (obj is null) ? null : obj.swigCPtr;
  }
...
class SWIGTYPE_p_unsigned___int64 {
  private void* swigCPtr;
  ...
  public static void* swigGetCPtr(SWIGTYPE_p_unsigned___int64 obj) {
    return (obj is null) ? null : obj.swigCPtr;
  }
