...
public:
    enum {
        ...
        MksPerSecond    = OVR.Timer.MsPerSecond * OVR.Timer.MksPerMs
    };
    ...
    {
        return cast(double)(ticks) * (1.0 / cast(double)OVR.Timer.MksPerSecond);
    }
    ...
    {
        return cast(double)(rawTicks) * rawFrequency;
    }
